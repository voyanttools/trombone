...
public class DocumentColemanLiauIndexTest {
    ...
    public void testWithFiles(
            ...
            double expectedColemanLiauIndex) throws IOException {
        ...
        for (ColemanLiauIndex colemanLiauIndex : colemanLiauIndexes) {
            assert colemanLiauIndex.getNbrOfLetters() == expectedNbrOfLetters;
            assert colemanLiauIndex.getNbrOfWords() == expectedNbrOfWords;
            assert colemanLiauIndex.getNbrOfSentences() == expectedNbrOfSentences;
    ...
    public void testWithRawText(Storage storage) throws IOException {
        ...
        parameters.addParameter("string", ColemanLiauIndexTest.TEXT);
        ...
        parameters.setParameter("tool", "corpus.DocumentColemanLiauIndex");
        ...
        for (ColemanLiauIndex colemanLiauIndex : colemanLiauIndexes)
            ...
            ColemanLiauIndexTest.assertColemanLiauIndexValues(colemanLiauIndex);
    }
}
