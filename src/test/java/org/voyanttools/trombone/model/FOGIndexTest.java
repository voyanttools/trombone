...
public class FOGIndexTest {
    ...
    public static final double EXPECTED_FOG_INDEX = 13.775275938189845;

    @Test
    public void test() {
        FOGIndex fogIndex = new FOGIndex(A_DOCUMENT_INDEX, A_DOCUMENT_ID, TEXT);

        assert fogIndex.docIndex == A_DOCUMENT_INDEX;
        assert fogIndex.docId.equals(A_DOCUMENT_ID);
        assert fogIndex.getFOGIndex() == EXPECTED_FOG_INDEX;
    }
}
