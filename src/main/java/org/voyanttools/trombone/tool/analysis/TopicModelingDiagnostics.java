...
/**
 * Copied from cc.mallet.topics 
 * Added method getDiagnostics
 */
public class TopicModelingDiagnostics {
	...
	public TopicModelingDiagnostics (ParallelTopicModel model, int numTopWords) {
	...
	public TopicScores getDocumentEntropy(int[] tokensPerTopic) {
		TopicScores scores = new TopicScores("documentEntropy", numTopics, numTopWords);
	...
	public TopicScores getDistanceFromUniform() {
		...
		TopicScores scores = new TopicScores("uniformDist", numTopics, numTopWords);
	...
	public TopicScores getEffectiveNumberOfWords() {
		...
		TopicScores scores = new TopicScores("effNumWords", numTopics, numTopWords);
	...
	public TopicScores getDistanceFromCorpus() {
		...
		TopicScores scores = new TopicScores("corpusDist", numTopics, numTopWords);
		scores.wordScoresDefined = true;
	...
	public TopicScores getTokenDocumentDiscrepancies() {
		TopicScores scores = new TopicScores("tokenDocDiff", numTopics, numTopWords);
		scores.wordScoresDefined = true;
	...
	public TopicScores getWordLengthScores() {
		...
		TopicScores scores = new TopicScores("wordLength", numTopics, numTopWords);
		scores.wordScoresDefined = true;
	...
	public TopicScores getWordLengthStandardDeviation() {
		...
		TopicScores scores = new TopicScores("wordLengthSD", numTopics, numTopWords);
		scores.wordScoresDefined = true;
	...
	public TopicScores getRank1Percent() {
		TopicScores scores = new TopicScores("rank1Docs", numTopics, numTopWords);
	...
	public TopicScores getDocumentPercentRatio(int numeratorIndex, int denominatorIndex) {
		TopicScores scores = new TopicScores("allocationRatio", numTopics, numTopWords);
	...
	public TopicScores getDocumentPercent(int i) {
		TopicScores scores = new TopicScores("allocationCount", numTopics, numTopWords);
	...
	public static void main (String[] args) throws Exception {
		...
		TopicModelingDiagnostics diagnostics = new TopicModelingDiagnostics(model, 20);
